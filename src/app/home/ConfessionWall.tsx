...
export default function ConfessionWall() {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-zinc-950 px-4 py-10">
      <h1 className="text-3xl md:text-4xl font-extrabold text-white tracking-tight">Confession Wall</h1>

      <div className="grid gap-4 md:gap-6 w-full max-w-3xl mt-8 md:mt-10">
        {confessions.map((confession, index) => (
          <div
            key={index}
            className="relative p-4 md:p-6 rounded-xl bg-stone-950 backdrop-blur-md shadow-lg border border-white/10 text-white transition hover:scale-[1.015] hover:shadow-2xl duration-300"
          >
            <p className="text-left text-base md:text-lg font-medium mb-4">{confession.message}</p>
