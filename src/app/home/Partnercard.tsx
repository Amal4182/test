    ...
    switch (currentPhotoIndex) {
      case 0:
        return {
          ...
          subtitle: `${partner.course} • ${partner.year === 1 ? "1st" : partner.year === 2 ? "2nd" : partner.year === 3 ? "3rd" : `${partner.year}th`} year`,
        }
      case 1:
        return { name: partner.name, title: "About You", subtitle: partner.bio }
      case 2:
        ...
        <Card className="relative">
          ...
          >
            <div className="relative w-full h-full">
              <Image
                src={normalizePhotoSrc(partner.photos[currentPhotoIndex])}
      ...
      <Dialog open={showDetails} onOpenChange={setShowDetails}>
        <DialogContent className="sm:max-w-[425px] max-h-[90vh] flex flex-col">
          <DialogHeader className="flex-none">
            ...
            <DialogDescription>
              {partner.course} • {partner.year === 1 ? "1st" : partner.year === 2 ? "2nd" : partner.year === 3 ? "3rd" : `${partner.year}th`} year
            </DialogDescription>
          </DialogHeader>
